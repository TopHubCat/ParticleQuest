...
**Note:** there currently is no documentation on how to edit ParticleQuest-specific objects/layers in Tiled. Please refer to `tmx/map.tmx` as an example if you want to create your own map.
...
- Write documentation about map editing in the Tiled editor (ie. editing ParticleQuest-specific properties of doors, chests, spawning areas, etc.)

- Write documentation about the ParticleQuest map JSON format, both for client and server map types.
